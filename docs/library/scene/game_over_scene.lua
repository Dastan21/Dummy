--[[
  Generated from ..\engine\scene\game_over_scene.lua

  Source: https://github.com/Dastan21/Dummy/blob/main/engine/scene/game_over_scene.lua
]]
...
--- @param x number
--- @param y number
function game_over.load(x, y) end

function game_over.update(dt) end
