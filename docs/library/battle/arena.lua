--[[
  Generated from ..\engine\battle\arena.lua

  Source: https://github.com/Dastan21/Dummy/blob/main/engine/battle/arena.lua
]]

---@meta

--- @class Dummy.Battle.Arena
---
...
--- Updates the arena, called on every game update
