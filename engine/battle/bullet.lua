...
local Bullet = Class(Sprite, "Dummy.Bullet")
...
function Bullet:setSprite(sprites_names, speed, loop, play, keep_last_frame)
  Sprite.setSprite(self, sprites_names, speed, loop, play, keep_last_frame)
